...
export const businessSchema = z.object({ googlePlaceId: z.string().max(200).default(''), name: text, category: text, city: text, address: text, phone: text, whatsapp: link, hours: text, rating: text, reviewCount: text, mapUrl: link });
